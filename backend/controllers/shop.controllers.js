...
export const createEditShop=async (req,res) => {
    try {
       ...
       await shop.populate("owner items")
        // Emit real-time notification for new shop creation
...
// Existing getMyShop functionality remains unchanged
export const getMyShop=async (req,res) => {
    try {
        ...
        if(!shop){
            // Return a 404 instead of null so frontend can handle missing shop
...
// Adds endpoint to fetch all shops

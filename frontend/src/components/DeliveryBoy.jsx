...
{generatedOtp && <div className='mb-3 p-3 bg-orange-100 rounded-lg text-center'>
<p className='text-xs text-gray-500 mb-1'>Share this OTP with customer:</p>
<p className='text-3xl font-bold text-orange-600 tracking-widest'>{generatedOtp}</p>
</div>}
<p className='text-sm font-semibold mb-2'>Enter OTP from <span className='text-orange-500'>{currentOrder.user.fullName}</span></p>
...
{message && <p className={`text-center text-2xl mb-4 ${isError ? 'text-red-500' : 'text-green-500'}`}>{message}</p>}
